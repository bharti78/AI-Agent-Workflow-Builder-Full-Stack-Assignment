...
export default async function handler(req: Request, res: Response) {
  ...
  // with a JSON body. Nhost Functions don't add CORS headers for you —
  // without this, every browser call fails before it even reaches the
  // logic below, regardless of auth or the request body.
